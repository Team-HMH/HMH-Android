...
interface ChallengeRepository {
    ...
    suspend fun getChallengeWithUsage(): Result<List<ChallengeWithUsageInput>>
    ...
    suspend fun uploadSavedChallenge(challengeWithUsageInputs: List<ChallengeWithUsageInput>): Result<Unit>
}
